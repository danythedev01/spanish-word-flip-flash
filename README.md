...
- [GitLab CI/CD Pipeline Tutorial for Beginners](https://www.youtube.com/watch?v=z7nLsJvEyMY)
- [Gitlab project](https://gitlab.com/gitlab-course-public/spanish-word-flip-flash)
- Use local config file `gitlab-ci.yml`
